...
--=============================
_ENV = Module "System.Collections.IIndexedListSorter" "1.0.0"
...
----------------------------
__Doc__[[Reverse the indexed list]]
__Arguments__{ Argument(Integer, true, 1), Argument(Integer, true, -1) }
