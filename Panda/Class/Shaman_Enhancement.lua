...
local function Shaman_Enhancement()  --更新主图标及技能提示图标

local mainbutton = PDUI.mainbutton
local debutton = PDUI.debutton

if PlayerClass() == "SHAMAN" and Specialization() == "增强" then
...
local Shaman_Enhancement = Shaman_Enhancement
ns.Shaman_Enhancement = Shaman_Enhancement
