...
local function Warlock_Affliction()  --更新主图标及技能提示图标

local mainbutton = PDUI.mainbutton
local debutton = PDUI.debutton

if PlayerClass() == "WARLOCK" and Specialization() == "痛苦" then
...
local Warlock_Affliction = Warlock_Affliction
ns.Warlock_Affliction = Warlock_Affliction
