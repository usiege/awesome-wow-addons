...
local function Priest_ShenSheng()  --更新主图标及技能提示图标

local mainbutton = PDUI.mainbutton
local debutton = PDUI.debutton

if PlayerClass() == "PRIEST" and Specialization() == "神圣" then
...
local Priest_ShenSheng = Priest_ShenSheng
ns.Priest_ShenSheng = Priest_ShenSheng
