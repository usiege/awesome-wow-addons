...
local function Shaman_Restoration()  --更新主图标及技能提示图标

local mainbutton = PDUI.mainbutton
local debutton = PDUI.debutton

if PlayerClass() == "SHAMAN" and Specialization() == "恢复" then
...
local Shaman_Restoration = Shaman_Restoration
ns.Shaman_Restoration = Shaman_Restoration
