...
local function Priest_Shadow()  --更新主图标及技能提示图标

local mainbutton = PDUI.mainbutton
local debutton = PDUI.debutton

if PlayerClass() == "PRIEST" and Specialization() == "暗影" then
...
local Priest_Shadow = Priest_Shadow
ns.Priest_Shadow = Priest_Shadow
