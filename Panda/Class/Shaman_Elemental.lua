...
local function Shaman_Elemental()  --更新主图标及技能提示图标

local mainbutton = PDUI.mainbutton
local debutton = PDUI.debutton

if PlayerClass() == "SHAMAN" and Specialization() == "元素" then
...
local Shaman_Elemental = Shaman_Elemental
ns.Shaman_Elemental = Shaman_Elemental
