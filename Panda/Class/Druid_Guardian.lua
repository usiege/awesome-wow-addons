...
local function Druid_Guardian()  --更新主图标及技能提示图标

local mainbutton = PDUI.mainbutton
local debutton = PDUI.debutton

if PlayerClass() == "DRUID" and Specialization() == "守护" then
...
local Druid_Guardian = Druid_Guardian
ns.Druid_Guardian = Druid_Guardian
