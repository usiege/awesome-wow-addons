...
local function Paladin_Shensheng()  --更新主图标及技能提示图标

local mainbutton = PDUI.mainbutton
local debutton = PDUI.debutton

if PlayerClass() == "PALADIN" and Specialization() == "神圣" then
...
if PandaDB.NQ_A7 ~= false  and Isuseable("审判",20271) then ShowColor(mainbutton.icon, 6603,A_7);ShowSpell(debutton.icon, 20271)  return end
if PandaDB.NQ_C1 ~= false  and Isuseable("神圣震击",20473) then ShowColor(mainbutton.icon, 6603,C_1);ShowSpell(debutton.icon, 20473)  return end
if active_enemies()>=3 then
if PandaDB.NQ_A9 ~= false  and Isuseable("奉献",205228) then ShowColor(mainbutton.icon, 6603,A_9);ShowSpell(debutton.icon, 205228)  return end
end
if PandaDB.NQ_A0 ~= false  and Isuseable("十字军打击",35395) then ShowColor(mainbutton.icon, 6603,A_0);ShowSpell(debutton.icon, 35395)  return end
if PandaDB.NQ_A9 ~= false  and Isuseable("奉献",205228) then ShowColor(mainbutton.icon, 6603,A_9);ShowSpell(debutton.icon, 205228)  return end
...
local Paladin_Shensheng = Paladin_Shensheng
ns.Paladin_Shensheng = Paladin_Shensheng
