...
--color
 ...
 A_1 = "Interface\\AddOns\\Panda\\media\\A1"  --A1 00B100   --萨满祭司 元素       
 A_2 = "Interface\\AddOns\\Panda\\media\\A2"  --A2 00B200   --萨满祭司 增强          
 A_3 = "Interface\\AddOns\\Panda\\media\\A3"  --A3 00B300   --德鲁伊 平衡          
 A_4 = "Interface\\AddOns\\Panda\\media\\A4"  --A4 00B400   --德鲁伊 野性        
 A_5 = "Interface\\AddOns\\Panda\\media\\A5"  --A5 00B500   --德鲁伊 守护        
 A_6 = "Interface\\AddOns\\Panda\\media\\A6"  --A6 00B600   --恶魔猎手 浩劫       
 A_7 = "Interface\\AddOns\\Panda\\media\\A7"  --A7 00B700   --恶魔猎手 复仇         
 A_8 = "Interface\\AddOns\\Panda\\media\\A8"  --A8 00B800   --死亡骑士 鲜血        
 A_9 = "Interface\\AddOns\\Panda\\media\\A9"  --A9 00B900   --死亡骑士 冰霜       
 A_0 = "Interface\\AddOns\\Panda\\media\\A0"  --A0 00C100   --死亡骑士 邪恶   
 ...
 C_1 = "Interface\\AddOns\\Panda\\media\\C1" --C1 00C200   --战士 武器         
 C_2 = "Interface\\AddOns\\Panda\\media\\C2" --C2 00C300   --战士 狂怒                                           
 C_3 = "Interface\\AddOns\\Panda\\media\\C3" --C3 00C400   --战士 防护
 C_4 = "Interface\\AddOns\\Panda\\media\\C4" --C4 00A200   --骑士 惩戒                                                                                                                        
 C_5 = "Interface\\AddOns\\Panda\\media\\C5" --C5 00A300   --骑士 防护                                                                                                                                                       
 C_6 = "Interface\\AddOns\\Panda\\media\\C6" --C6 00A400   --猎人 野兽控制                                                                                                                                       
 C_7 = "Interface\\AddOns\\Panda\\media\\C7" --C7 00A500   --猎人 射击                                                                                                                
 C_8 = "Interface\\AddOns\\Panda\\media\\C8" --C8 00A600   --猎人 生存     
 C_9 = "Interface\\AddOns\\Panda\\media\\C9" --C9 00D200   --盗贼 奇袭
 C_0 = "Interface\\AddOns\\Panda\\media\\C0" --C0 00D100   --盗贼 狂徒
 
 S_1 = "Interface\\AddOns\\Panda\\media\\S1" --S1 00A900   --盗贼 敏锐 
 S_2 = "Interface\\AddOns\\Panda\\media\\S2" --S2 00A800   --牧师 暗影
 S_3 = "Interface\\AddOns\\Panda\\media\\S3" --S3 00A700   --法师 奥术
 S_4 = "Interface\\AddOns\\Panda\\media\\S4" --S4 00E300   --法师 火焰
 S_5 = "Interface\\AddOns\\Panda\\media\\S5" --S5 00E500   --法师 冰霜
 S_6 = "Interface\\AddOns\\Panda\\media\\S6" --S6 00E800   --术士 痛苦
 S_7 = "Interface\\AddOns\\Panda\\media\\S7" --S7 00E900   --术士 恶魔学识
 S_8 = "Interface\\AddOns\\Panda\\media\\S8" --S8 00C500   --术士 毁灭
 S_9 = "Interface\\AddOns\\Panda\\media\\S9" --S9 00E400   --武僧 酒仙
 S_0 = "Interface\\AddOns\\Panda\\media\\S0" --S0 00E600   --武僧 踏风
...
--显示职业函数
function ShowClass(self,path) --显示色块图标(填入path则返回材质地址，不填则返回spell_id对应图标)
...
--职业显示 UI
-- Class = CreateFrame("Frame", "classui", UIParent)
-- Class:SetBackdropColor(1.0, 0, 0, 0.9)
-- Class:SetPoint("TOPLEFT", UIParent, "TOPLEFT", 1,1)
-- -- Class:SetAllPoints(UIParent)
-- Class.texture = Class:CreateTexture(nil, "BORDER")
-- -- Class.texture:SetAllPoints(UIParent)
-- Class.texture:SetTexCoord(0.1,0.9,0.1,0.9)
-- --Class.texture:SetVertexColor(1.0, 0, 0, 0.9)
-- Class.texture:SetPoint("TOPLEFT", UIParent, "TOPLEFT", 1,1)
-- Class.texture:SetSize(20,20)
-- Class.texture:SetTexture(sk_0)


PDUI.mainbutton.Class = CreateFrame("Frame", nil, PDUI.mainbutton)
PDUI.mainbutton.Class:SetAllPoints(PDUI.mainbutton)
PDUI.mainbutton.Class.texture = PDUI.mainbutton.Class:CreateTexture(nil, "BORDER")
PDUI.mainbutton.Class.texture:SetTexCoord(0.1,0.9,0.1,0.9)
PDUI.mainbutton.Class.texture:SetTexture(sk_0)
PDUI.mainbutton.Class.texture:SetPoint("TOPLEFT", PDUI.mainbutton, "TOPLEFT", 1,1)
PDUI.mainbutton.Class.texture:SetSize(20,20)
PDUI.mainbutton.Class:Show()
