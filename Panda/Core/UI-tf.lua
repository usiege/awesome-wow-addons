...
if CCFrame then
	print(CCFrame)
	print(MarkFrame)
	CCFrame:SetSize(CCFrameSize, CCFrameSize)
end

print("strata: " .. PDUI:GetFrameStrata())
print("level: " .. PDUI:GetFrameLevel())
...
local function CreateBorder(parent, r, g, b, a, size, br, bg, bb)
	...
	local pad = 5
	sd:SetPoint("TOPLEFT", parent, "TOPLEFT", -pad, pad)
	sd:SetPoint("BOTTOMRIGHT", parent, "BOTTOMRIGHT", pad, -pad)
...
-- Class:SetPoint("TOPLEFT", UIParent, "TOPLEFT", 200,-200)
...
-- 这里存在一个边框，这个边框有宽度
CreateBorder(PDUI.mainbutton.icon, 1, 0, 0, 1, 3, 0, 0, 0)
